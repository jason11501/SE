...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edtuser.setText(""+loginPreferences.getString("usr",""));
        edtpassword.setText(""+loginPreferences.getString("pwd",""));
        checkBox.setChecked(loginPreferences.getBoolean("checked",false));
                ...
                else
                {
                    ...
                    if (users.size()>0)
                    {
                        ...
                        if (checkBox.isChecked()){
                            ...
                            loginPrefsEditor.putString("pwd",mk);
                            loginPrefsEditor.putString("usr",ten);
                            loginPrefsEditor.putBoolean("checked",true);
                            loginPrefsEditor.commit();
                        }
                        else {
                            loginPrefsEditor.remove("pwd");
                            loginPrefsEditor.remove("usr");
                            loginPrefsEditor.remove("checked");
                            loginPrefsEditor.commit();
                        }
        ...
        btndangki.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                EditText edtdkpassword1=dialog.findViewById(R.id.edtdkpassword1);
                ...
                btndkxacnhan.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        mk1=edtdkpassword1.getText().toString();

                        if (ten.isEmpty()||mk.isEmpty()||mk1.isEmpty()){
                            Toast.makeText(LoginActivity.this,"Vui lòng nhập đủ thông tin cần thiết",Toast.LENGTH_SHORT).show();
                            return;
                        }

                        if (ten.length()<10){
                            Toast.makeText(LoginActivity.this,"Tên đăng nhập phải tối thiểu 10 kí tự",Toast.LENGTH_SHORT).show();
                            return;
                        }

                        if (mk.length()<8){
                            Toast.makeText(LoginActivity.this,"Mật khẩu phải tối thiểu 8 kí tự",Toast.LENGTH_SHORT).show();
                            return;
                        }

                        if (mk.equals(mk1)==false){
